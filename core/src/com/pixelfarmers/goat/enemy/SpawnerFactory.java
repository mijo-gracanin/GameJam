...
public class SpawnerFactory {
    ...
    public static Array<EnemySpawner> createSpawnersForLevel(EnemyManager enemyManager, int levelId) {
        ...
        if(levelId == 1) {
            EnemySpawner spawner1 = new EnemySpawner(enemyManager, new Vector2(160, 100), 12, 1, 1);
            EnemySpawner spawner2 = new EnemySpawner(enemyManager, new Vector2(27 * Tile.TILE_SIZE , 11 * Tile.TILE_SIZE), 12, 0.5f, 2);
