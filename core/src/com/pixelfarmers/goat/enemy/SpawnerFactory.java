...
public class SpawnerFactory {
    ...
    public static Array<EnemySpawner> createSpawnersForLevel(EnemyManager enemyManager, int levelId) {
        ...
        if(levelId == 1) {
            EnemySpawner spawner1 = new BatSpawner(enemyManager, new Vector2(160 + 320, 100 + 320), 12, 1, 1);
            EnemySpawner spawner2 = new MummySpawner(enemyManager, new Vector2(27 * Tile.TILE_SIZE + 320, 11 * Tile.TILE_SIZE + 320), 12, 0.5f, 2);
